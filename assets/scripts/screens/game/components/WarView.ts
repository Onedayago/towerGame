...
import { EnemyManager, WeaponManager, BulletManager, BaseManager, WaveManager } from '../../../managers/Index';
    ...
    start() {
        ...
        if (this.enemyManager && this.baseNode) {
            ...
            if (baseCenter) {
                ...
                const pathFinder = this.enemyManager.initPathfinder(this.weaponManager);
